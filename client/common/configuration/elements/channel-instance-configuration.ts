...
import { tplChannelInstanceConfiguration } from './templates/channel-instance-configuration'
...
@customElement('livechat-channel-instance-configuration')
export class ChannelInstanceConfigurationElement extends LivechatElement {
  ...
  protected override render = (): unknown => {
    return this._asyncTaskRender.render({
      ...
      complete: () => tplChannelInstanceConfiguration(this)
    })
  }
}
