...
import type { ChannelInstanceConfigurationElement } from '../channel-instance-configuration'
...
export function tplChannelInstanceConfiguration (el: ChannelInstanceConfigurationElement): TemplateResult {
      ...
      <form livechat-configuration-channel-options role="form" @submit=${el.saveConfig} @change=${el.resetValidation}>
        ...
        <div class="form-group">
          ...
          <livechat-form-checkbox
            id="peertube-livechat-force-bot"
            label="Force"
            .model=${true}
            @model-update=${(event: CustomEvent) => {}}
            class="ms-3"
          ></livechat-form-checkbox>
        </div>
